...
<head>
  ...
  <title>Saha Veiculos</title>

  <!-- CSS  -->
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
  <link href="../css/materialize.css" type="text/css" rel="stylesheet" media="screen,projection"/>
  <link href="../css/style.css" type="text/css" rel="stylesheet" media="screen,projection"/>
  <link href="../css/stylesaha.css" type="text/css" rel="stylesheet" />
...
<body>
<div  style="background-color:#f23f3d;" class="btn"><a style=" color: #fff"  onclick="window.print()">Imprimir</a></div>
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
        <br /><br />
        <div class="row center">
            <img width="200px" src="../assets/imagens/logosahaveiculos.svg"/>
